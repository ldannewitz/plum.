...
m3 = Membership.create!(member_id: brad.id, group_id: cubs_infield.id)
...
x2 = Expense.create!(event_id: event.id, spender_id: rizzo.id, description: "dinner", amount: 58.21, location: "Des Moines") #, created_at: "2016-06-04 16:40:00", updated_at: "2016-06-04 16:40:00")
...
x6 = Expense.create!(event_id: event.id, spender_id: brad.id, description: "snacks", amount: 5.21, location: "DeKalb") #, created_at: "2016-06-05 13:45:00", updated_at: "2016-06-05 13:45:00")
